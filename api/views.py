...
from .serializers import PostSerializer, CommentSerializer, PostListSerializer, CategorySerializer
...
class PostView(APIView):
    ...
    def get(self, request, post_id, format=None):
        try:
            ...
            return Response({'post': post_serializer.data, 'commnets': comment_serializer.data})
